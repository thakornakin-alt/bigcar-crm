...
export const documentTemplates: DocumentTemplateConfig[] = [
  ...
  },
  {
    ...
    fields: {
      transactionDate: { page: 1, x: 466, y: 727, fontSize: 10, type: "date", pdfFieldName: "Text7" },
      customerName: { page: 1, x: 377, y: 679, fontSize: 10, pdfFieldName: "Text8" },
      idCard: { page: 1, x: 445, y: 650, fontSize: 10, pdfFieldName: "Text9" },
      customerAddress: { page: 1, x: 95, y: 627, fontSize: 9, width: 425, pdfFieldName: "Text10" },
      phone: { page: 1, x: 475, y: 643, fontSize: 10, pdfFieldName: "Text11" },
      plate: { page: 1, x: 84, y: 590, fontSize: 10, pdfFieldName: "Text15" },
      carBrand: { page: 1, x: 246, y: 608, fontSize: 10, pdfFieldName: "Text13" },
      carModel: { page: 1, x: 361, y: 608, fontSize: 10, width: 210, pdfFieldName: "Text14" },
      engineNo: { page: 1, x: 222, y: 590, fontSize: 10, pdfFieldName: "Text16" },
      vin: { page: 1, x: 280, y: 556, fontSize: 9, width: 165, pdfFieldName: "Text4" },
      salePrice: { page: 1, x: 327, y: 539, fontSize: 10, pdfFieldName: "Text17" },
      bookingPrice: { page: 1, x: 272, y: 522, fontSize: 10, pdfFieldName: "Text3" },
      financeAmount: { page: 1, x: 86, y: 504, fontSize: 10, pdfFieldName: "Text1" },
      sellerName: { page: 1, x: 361, y: 590, fontSize: 10, pdfFieldName: "Text6" },
      signatureName: { page: 1, x: 73, y: 626, fontSize: 10, pdfFieldName: "Text12" }
    }
  },
  {
    id: "payment-receipt",
