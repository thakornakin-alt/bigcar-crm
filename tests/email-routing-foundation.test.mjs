...
test("Booking and Sales draft APIs overwrite browser recipients", async () => {
  for (const path of ["app/api/email/booking-draft/route.ts", "app/api/email/sales-draft/route.ts"]) {
