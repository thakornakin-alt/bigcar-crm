  ...
  return (
    <PageContainer wide>
      <PageTitle
        ...
        subtitle="เก็บ Lead ติดตามลูกค้า นัดหมาย และเตรียม Smart Stock Matching โดยไม่ Auto จองหรือเปลี่ยนสถานะเอง"
        actions={
          <TopMenuButton href="/front-office-calendar" icon={<CalendarDays size={18} />} variant="primary">
            ปฏิทินหน้าบ้าน
          </TopMenuButton>
        }
      />
        ...
        <section className="space-y-4">
          ...
          <SectionCard title="เพิ่มลูกค้ามุ่งหวัง" icon={<UserRound size={18} />}>
            ...
            <div className="rounded-lg border border-line bg-[#0b0d11] px-3 py-3 text-sm leading-6 text-soft">
              Phase นี้เป็น UI shell เพื่อจัด flow ใหม่ก่อน ยังไม่เปลี่ยน logic ลูกค้าเดิมในหน้าแรก
            </div>
          </SectionCard>
        </section>
